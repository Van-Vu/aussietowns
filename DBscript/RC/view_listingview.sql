...
CAST(concat(
    '[', 
    group_concat(concat('{', '"startDate":"', COALESCE(s.startDate,''), '","duration":"', COALESCE(s.duration,''), '","endDate":"', COALESCE(s.endDate,''), '","repeatedType":"', COALESCE(s.repeatedType,''), '","repeatedDay":[', COALESCE(s.repeatedDay,''), ']}')),
    ']'
