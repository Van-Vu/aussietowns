...
var TourDetailFormComponent = (function () {
    function TourDetailFormComponent(fb, userService, sanitizer, element) {
        this.fb = fb;
    ...
    TourDetailFormComponent.prototype.showCam = function () {
        var _this = this;
    ...
    TourDetailFormComponent.prototype.capture = function () {
    ...
    TourDetailFormComponent.prototype.onLogin = function () {
    ...
    TourDetailFormComponent.prototype.onValueChanged = function (data) {
        if (!this.model) {
            return;
        }
        var form = this.model;
